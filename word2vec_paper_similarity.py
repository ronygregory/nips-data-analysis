...
if __name__=="__main__":
    ...
    w2v_model=word2vec_model_creation(abstract_data,inp_kgrams_phrases,int(inp_len),inp_column)
    #init_notebook_mode()
    ...
    sim_indices=sim_comp(w2v_model,abstract_data,inp_avg_or_clustering)   
